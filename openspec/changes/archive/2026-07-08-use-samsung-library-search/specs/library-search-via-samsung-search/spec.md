# library-search-via-samsung-search

## Purpose

Library search SHALL use Samsung Search's public query API when the search field is non-blank, while blank search continues to show the normal local library list.
