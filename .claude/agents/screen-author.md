---
name: screen-author
description: Scaffolds Compose screens following the project's strict four-file pattern. Asks for screen purpose before writing state fields. Routing keywords — screen, Compose, ViewModel, UiState, Action, Effect.
