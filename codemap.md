...
| `app/src/main/java/com/opus/readerparser/core/di/` | Contains **all Hilt modules** that wire the app's object graph. | [View Map](app/src/main/java/com/opus/readerparser/core/di/codemap.md) |
...
| `app/src/main/java/com/opus/readerparser/workers/` | Background task orchestration via Android `WorkManager`. | [View Map](app/src/main/java/com/opus/readerparser/workers/codemap.md) |
